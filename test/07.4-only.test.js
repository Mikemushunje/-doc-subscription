...
describe("Test 7.4 Only - Partial balance", function () {
  it("Should revert if subscriber has partial balance (8 DOC for 10 DOC charge)", async function () {
    ...
    // Mint exactly 8 DOC (not 1000)
    await mockToken.mint(subscriberWallet.address, ethers.parseEther("8"));
